...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(KC_ESCAPE,KC_1,KC_2,KC_3,KC_4,KC_5,KC_LEFT,LT(2,KC_TAB),KC_Q,KC_W,KC_F,KC_P,KC_G,KC_LBRACKET,MO(1),KC_A,KC_R,KC_S,KC_T,KC_D,SFT_T(KC_LALT),CTL_T(KC_Z),KC_X,KC_C,KC_V,KC_B,KC_APPLICATION,KC_LCTL,LCTL(KC_X),LCTL(KC_C),LCTL(KC_V),KC_LGUI,ALT_T(KC_APPLICATION),KC_LGUI,KC_HOME,SFT_T(KC_NO),KC_BSPACE,KC_END,KC_RIGHT,KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINUS,KC_RBRACKET,KC_J,KC_L,KC_U,KC_Y,KC_SCOLON,KC_BSLASH,KC_H,KC_N,KC_E,KC_I,KC_O,GUI_T(KC_ENTER),KC_ESCAPE,KC_K,KC_M,KC_COMMA,KC_DOT,KC_SLASH,KC_TILD,LCTL(KC_Z),KC_RALT,KC_QUOTE,KC_EQUAL,KC_RCTRL,KC_LALT,KC_GRAVE,KC_PGUP,KC_PGDOWN,KC_TAB,CTL_T(KC_SPACE)),

  [1] = KEYMAP(RESET,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_TRANSPARENT,KC_TRANSPARENT,KC_ESCAPE,KC_MS_WH_UP,KC_LCBR,KC_RCBR,KC_MS_UP,KC_TRANSPARENT,KC_TRANSPARENT,KC_LALT,KC_MS_WH_DOWN,KC_LSHIFT,KC_LCTL,KC_MS_DOWN,KC_TRANSPARENT,LCTL(KC_Z),LCTL(KC_X),LCTL(KC_C),LCTL(KC_V),KC_MS_BTN2,KC_TRANSPARENT,TG(3),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_MS_BTN1,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_F6,KC_F7,KC_F8,KC_F9,KC_F10,KC_F11,KC_TRANSPARENT,KC_PGDOWN,KC_HOME,KC_UP,KC_END,KC_DELETE,KC_F12,KC_PGDOWN,KC_LEFT,KC_DOWN,KC_RIGHT,KC_BSPACE,KC_ENTER,KC_TRANSPARENT,KC_TRANSPARENT,KC_1,KC_2,KC_3,KC_TRANSPARENT,KC_APPLICATION,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT),
